...
class MainWindow():
    def __init__(self, root):
        # list of imgs located in each categorical directories
        ...
        # buttons
        btn1 = Button(root, text='한식', padx=20, font=('나눔바른펜', 20, 'bold'), command=lambda: self.update_img(self.img_korean, 'korean'))
        btn1.pack()
        btn2 = Button(root, text='양식', padx=20, font=('나눔바른펜', 20, 'bold'), command=lambda: self.update_img(self.img_western, 'western'))
        btn2.pack()
        btn3 = Button(root, text='중식', padx=20, font=('나눔바른펜', 20, 'bold'), command=lambda: self.update_img(self.img_chinese, 'chinese'))
        btn3.pack()
        btn4 = Button(root, text='일식', padx=20, font=('나눔바른펜', 20, 'bold'), command=lambda: self.update_img(self.img_japanese, 'japanese'))
        btn4.pack()
        btn5 = Button(root, text='분식', padx=20, font=('나눔바른펜', 20, 'bold'), command=lambda: self.update_img(self.img_bunsik, 'bunsik'))
        btn5.pack()
    ...
    # update img on click
    def update_img(self, img_list, type):
